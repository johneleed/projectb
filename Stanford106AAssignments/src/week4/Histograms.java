/*This program reads a list of exam scores from the file
MidtermScores.txt and displays a histogram of those numbers, 
divided into the ranges 0–9, 10–19, 20–29, and so forth, up to the range
